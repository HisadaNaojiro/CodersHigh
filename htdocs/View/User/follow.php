<?php
	...
	$FollowUserCollection = $User->getCollectionByFollowId($UserArray['id']);
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8 col-md-offset-1">
				<?php foreach($FollowUserCollection as $FollowUserArray): ?>
					<div class="col-xs-6 col-md-4">
						<div class="thumbnail">
							...
							<div class="caption">
								<h3><?php echo $loader->View->h($FollowUserArray['name']);?></h3>
								<div id="follow-space" data-user-id="<?php echo $FollowUserArray['id']?>">
									<button  data-type="follow" class="btn btn-warning btn-block js-follow-button follow" style ="display: none;">
										フォロー
									</button>
								
									<button data-type="unfollow" class="btn btn-default btn-block js-follow-button unfollow">
										アンフォロー
									</button>
								</div>
							</div>
